//демонстрация перегрзуки методов
class Overl {
    int s; 
    Overl() {
    ...
    void ovlDemo() {
        System.out.println("Выполненеи метода без параметров");
    }
    void ovlDemo(int a) {
 ...
 class Summation {
    ...
    Summation(int num) {
        sum =0;
        System.out.println("//Начало цикла Summation//");
        for (int i = 0; i <= num; i++) {
            sum += i;
            System.out.println(i + " " + sum);
        }
        System.out.println("//Конец цикла Summation//");
    }
...
class Overload {
    public static void main(String[] args) {
        ...
        System.out.println();
        resI = ob.ovlDemo(3,7);
        System.out.println("Результат выполненния ob.ovlDemo(3,7): " + resI);
        System.out.println();
        ob.ovlDemo(6);
        System.out.println();
        resD = ob.ovlDemo(3.5, 8.5);
        System.out.println("Результат выполненния ob.ovlDemo(3.5, 8.5): " + resI);

        //автоматическое преобразование типа при перегрузке 
        System.out.println();
        int i = 10;
        double d = 99.9;
        byte b = 30;
        ...
        //Демонстрация перегрузки коснтурктора
        Overl t1 = new Overl();
        ...
        //демонстрация инициализация одного объекта на основе другого
